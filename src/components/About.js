...
const About = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-gray-800 p-6">
      <div className="max-w-3xl w-full bg-white p-6 sm:p-8 rounded-lg shadow-lg">
        ...
        <div className="mt-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-3">Why Choose Us?</h2>
        ...
        <div className="mt-8 text-center">
          <button 
            className="px-6 py-3 bg-orange-500 text-white text-lg sm:text-xl rounded-lg shadow-md hover:bg-orange-600 transition-all duration-300 cursor-pointer"
            onClick={() => { navigate("/"); }}
          >
            Order Now
          </button>
